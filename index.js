...
// ---------------------------
const BOT_TOKEN = '8169992260:AAGmsEFpruItGAouT1wCmbVwBK1NjQTp0uU'; // <<--- put your bot token here
const ADMIN_IDS = [8448744863]; // <<--- put admin numeric Telegram IDs here
const FORCE_CHANNEL = '@fflemcy'; // <<--- channel username, e.g. @mychannel
const VERIFY_SITE_URL = 'https://verifybo.netlify.app'; // <<--- static page you deploy
